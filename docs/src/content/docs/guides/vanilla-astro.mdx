...
2. Make sure that Griffe is available in your system's Python, or that
   ...
   it writes. See [Without Python](../getting-started/#without-python) for more information.

3. Add the integration. The import is `starlight-pydocs/astro`: the package's default export is a
